...
- `/theater` 已完成三入口 IA、訪綱建場 prototype、previsit/client source review 與高敏感 gate proof；仍需 TDF-006 做跨狀態 QA 後才能把 TDF-004 全卡打勾。
- `RES-003` 劇場場域建構訪綱 B 已能產生 setup/build packet；下一個高槓桿缺口是把 setup draft 明確交接到 Route B 多角色 runtime。
- Route B 多角色、導演編排、群聊/私聊、人物狀態更新與五視角回饋仍由 TDF-005 + ITA-003/004/006 管理；不得在未完成 handoff/migration brief 前順手改 legacy Theater schema。
