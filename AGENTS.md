...
- **REL-006/006b/006c/006d 已於 2026-06-24 完成**：`FamilyMember.metadata.profile` allowlist 可安全表達人物職位/職業、財務依賴、狀態、決策角色與關係脈絡，已串入 relationship graph source review、準備包 -> 劇場建場、Route B session source grounding，且 `/crm/[clientId]/relationships` 具備顧問可操作的人物資料編輯器；仍不改 schema、不寫回 VisitPlan/CRM fact/relationship graph。
