...
- REL-001/002 已完成最小 no-schema 修復：runtime 不再讀寫 `Client.parentMemberId`，root-connected 長輩會畫成 `PARENT_OF` edge，child / parent create path 都改為 BFF-confirmed，refresh/new context 可驗。
