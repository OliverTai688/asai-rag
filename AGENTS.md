...
Whole-product review 註記（2026-06-24 family profile runtime calibration）：`REL-006/006b/006c/006d/006e/006f/006g` 已把人物 profile 從 CRM/relationship graph 帶到 preparation/theater handoff、Route B session source panel、advisor editor、next-turn/provider runtime、feedback review/provider grounding，以及準備包/AI Meeting notes advisor context。下一個最高槓桿若 operator 批准 formal `RelationshipEdge` schema/migration 或回答 relationship confirmation A/B/C，則優先處理該批准/決策；未批准前可改做 clean-browser cross-flow proof。
