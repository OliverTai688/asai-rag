...
const outDir = join(root, ".tmp", "theater-route-b-severe-red-line-preview-dry-run");
...
try {
  execFileSync(
    ...
    [
      ...
      "--outDir",
      outDir,
      "scripts/theater-route-b-severe-red-line-preview-dry-run.ts",
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-route-b-severe-red-line-preview-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
