...
const outDir = join(root, ".tmp", "theater-client-build-route-b-handoff-dry-run");
...
try {
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-client-build-route-b-handoff-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
