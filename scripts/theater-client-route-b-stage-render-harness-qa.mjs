...
const outDir = join(root, ".tmp", "theater-client-route-b-stage-render-harness-qa");
...
try {
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-client-route-b-stage-render-harness-qa.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
