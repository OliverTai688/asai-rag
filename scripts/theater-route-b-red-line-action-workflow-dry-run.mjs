...
const outDir = join(root, ".tmp", "theater-route-b-red-line-action-workflow-dry-run");
...
try {
  execFileSync(
    ...
    [
      ...
      "--outDir",
      outDir,
      "scripts/theater-route-b-red-line-action-workflow-dry-run.ts",
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-route-b-red-line-action-workflow-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
