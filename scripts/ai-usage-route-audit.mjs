...
const routeManifest = [
  ...
  deterministicRoute({
    route: "/api/ai/meeting/sessions/[sessionId]/turns/[turnId]",
    file: "src/app/api/ai/meeting/sessions/[sessionId]/turns/[turnId]/route.ts",
    module: "MEETING",
    methods: ["PATCH", "DELETE"],
    inputEvidence: ["updateMeetingNoteInputSchema", "findMeetingPayloadViolations", "safeParse"],
    noProviderEvidence: [
  ...
  providerRoute({
    route: "/api/ai/meeting/sessions/[sessionId]/transcribe",
    file: "src/app/api/ai/meeting/sessions/[sessionId]/transcribe/route.ts",
    module: "MEETING",
