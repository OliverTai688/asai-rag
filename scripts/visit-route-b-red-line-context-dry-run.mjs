...
const outDir = join(root, ".tmp", "visit-route-b-red-line-context-dry-run");
...
try {
  execFileSync(
    ...
    [
      ...
      "--outDir",
      outDir,
      "scripts/visit-route-b-red-line-context-dry-run.ts",
  ...
  execFileSync("node", [join(outDir, "scripts", "visit-route-b-red-line-context-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
