...
const outDir = join(root, ".tmp", "theater-client-route-b-next-turn-context-dry-run");
...
try {
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-client-route-b-next-turn-context-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
