...
const outDir = join(root, ".tmp", "theater-route-b-feedback-provider-dry-run");
...
try {
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-route-b-feedback-provider-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
