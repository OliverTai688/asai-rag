...
const outDir = join(root, ".tmp", "theater-route-b-red-line-action-persistence-qa");
...
try {
  execFileSync(
    ...
    [
      ...
      "--outDir",
      outDir,
      "scripts/theater-route-b-red-line-action-persistence-qa.ts",
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-route-b-red-line-action-persistence-qa.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
