...
const outDir = join(root, ".tmp", "theater-route-b-next-turn-dry-run");
...
try {
  execFileSync(
    ...
    [
      ...
      "--outDir",
      outDir,
      "scripts/theater-route-b-next-turn-dry-run.ts",
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-route-b-next-turn-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
