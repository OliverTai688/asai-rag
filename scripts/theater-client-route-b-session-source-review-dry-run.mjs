...
const outDir = join(root, ".tmp", "theater-client-route-b-session-source-review-dry-run");
...
try {
  ...
  execFileSync("node", [join(outDir, "scripts", "theater-client-route-b-session-source-review-dry-run.js")], {
    cwd: root,
    stdio: "inherit",
  });
} finally {
