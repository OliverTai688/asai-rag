    ...
    proof: {
      ...
      sourceAdoption: {
        ...
        notes: [
          ...
          "Future summary provider, meeting chat, cross-meeting retrieval, additional global entrypoints, and writeback routes require separate source/proof slices.",
        ],
      },
      knownBlockers: [
