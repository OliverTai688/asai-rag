...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-005d-red-line-action-workflow",
      status: "active",
    },
    capabilities: [
      {
    ...
    interfaces: {
      ...
      actions: [
        ...
        },
        {
          ...
          actionBoundary: "Allows watching, evidence-needed, not-applicable, and escalation action states as advisor-visible handling only; current persistence is UI-local and future DB persistence is limited to ruleId/state/reasonCode/updatedAt.",
        },
      ],
      exportTargets: defaultExportTargets,
    },
    ...
    proof: {
      ...
      sourceAdoption: {
        ...
        notes: [
          ...
          "Severe red-line action workflow dry-run proves advisor action states for evidence-needed, not-applicable, and escalation remain UI-local, no-provider, no-notification, and no confirmed CRM fact writes.",
      ...
      knownBlockers: [
        ...
        "Formal compliance ops persistence, notifications, and legal review routing remain future work; current action workflow is advisor-visible UI-local state only.",
      ],
    },
    registry: commonRegistry,
  },
