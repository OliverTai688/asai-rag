...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    ...
    auth: {
      sessionType: "app-member",
      scopeDerivation: "AMM-003b BFF derives organization/member scope with requireCurrentMember, requires owner-scoped CLIENT_MEETING sessions or owner-scoped Client records, and keeps meeting snapshots/summaries/memory-chat/writeback previews member-private.",
    ...
    privacy: {
      retention: "AMM-003b persists member-private CLIENT_MEETING sessions, text/final transcript turns, Park-style memory candidates, deterministic or provider cited InterviewMeetingSummary rows, provider summary AiUsageLog rows, and selected writeback InteractionEvent candidates/tasks. Memory chat is deterministic response-only and does not persist chat transcripts.",
    ...
    proof: {
      ...
      notes: [
        ...
        "Additional global entrypoints and meeting workspace writeback UI require separate source/proof slices.",
      ],
    },
    knownBlockers: [
