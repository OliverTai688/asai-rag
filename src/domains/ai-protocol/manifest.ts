...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
    ...
    interfaces: {
      ...
      actions: [
        ...
        },
        {
          ...
          actionBoundary: "Supplies selected objection cues and all red-line rules to next-turn/feedback provider inputs without treating roleplay cues as confirmed CRM facts or legal advice.",
        },
        {
          id: "route-b-severe-red-line-warning-preview",
    ...
    proof: {
      ...
      sourceAdoption: {
        ...
        notes: [
          ...
          "Feedback review QA proves deterministic owner-scoped persistence under sceneState.feedbackReview, no-provider boundaries, red-line not-applicable posture, and stage UI display without CRM fact writes.",
  ...
  },
  {
    identity: {
      ...
      module: "MEETING",
      version: "2026-06-22.amm-quick-note-intake",
      status: "active",
    },
    capabilities: [
      {
