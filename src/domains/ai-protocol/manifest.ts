...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "MEETING",
      version: "2026-06-22.amm-005j-notes-hub-quarantine",
      status: "active",
    },
    capabilities: [
      {
    ...
    knownBlockers: [
      "Quick-note local store and note-domain prototype files remain unaccepted unless a later AMM/PIM slice adds server-owned persistence, BFF scope checks, writeback boundary, and dedicated QA.",
