...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-005k-compliance-review-intake",
      status: "active",
    },
    capabilities: [
      {
    ...
    proof: {
      ...
      knownBlockers: [
        ...
        "Formal compliance ops persistence, notifications, and legal review routing remain future work; current intake emits disabled/no-provider candidates only.",
      ],
    },
    registry: commonRegistry,
  },
