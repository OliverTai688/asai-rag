...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-005c-severe-red-line-preview",
      status: "active",
    },
    capabilities: [
      {
    ...
    proof: {
      ...
      knownBlockers: [
        ...
        "Live next-turn provider route wiring and provider-candidate DB/browser append proof remain missing; append confirmation API/UI source contract is guarded until a real usageLogId candidate exists.",
