...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-003n-next-turn-provider-route",
      status: "active",
    },
    capabilities: [
      {
    ...
    proof: {
      ...
      knownBlockers: [
        ...
        "Full compliance ops action flow for severe red-line escalation remains missing; current preview is watchlist-only.",
      ],
    },
    registry: commonRegistry,
  },
