...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-005e-red-line-action-persistence",
      status: "active",
    },
    capabilities: [
      {
    ...
    proof: {
      ...
      knownBlockers: [
        ...
        "Formal compliance ops persistence, notifications, and legal review routing remain future work; current action persistence stores advisor handling state only.",
      ],
    },
    registry: commonRegistry,
  },
