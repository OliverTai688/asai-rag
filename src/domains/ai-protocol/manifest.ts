...
export const ASAI_AGENT_PROTOCOL_MANIFESTS: AgentProtocolManifest[] = [
  ...
  },
  {
    identity: {
      ...
      module: "THEATER",
      version: "2026-06-22.ita-003l-next-turn-provider-log-contract",
      status: "active",
    },
    capabilities: [
      {
    ...
    proof: {
      ...
      knownBlockers: [
        ...
        "Live next-turn provider route wiring and persisted append confirmation UI remain disabled until DB/browser runtime proof exists.",
