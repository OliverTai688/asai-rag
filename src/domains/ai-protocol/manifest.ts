  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        summary: "Turns safe Route B feedback family profile advisor context into meeting writeback preview context cards that require a persisted summary and advisor confirmation before any writeback review.",
    ...
    interfaces: {
      ...
      actions: [
        ...
        },
        {
          ...
          actionBoundary: "Client UI derives preview-only writeback context from safe feedback family profile advisor cards, requires a persisted meeting summary and advisor confirmation, and never writes relationship graph, VisitPlan, client profile, policy, or confirmed CRM facts.",
        },
        {
