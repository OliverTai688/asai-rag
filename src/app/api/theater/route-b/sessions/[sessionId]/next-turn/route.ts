...
interface RouteBSessionNextTurnRouteContext {
  params: Promise<{ sessionId: string }>;
}

export async function GET(_req: Request, ctx: RouteBSessionNextTurnRouteContext) {
  try {
    ...
    return Response.json(buildTheaterRouteBNextTurnDraft(result.data), {
      headers: {
