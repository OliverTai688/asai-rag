...
- [x] 建立 Sentry 或等價錯誤監控方案；若暫不接，寫入 release blocker。
...
- [x] 做 full smoke：front office、member admin、org admin、super admin、client portal。
- [x] 保存 release QA evidence：desktop/mobile screenshots、console error、API status、AiUsageLog count、demo relogin result。
