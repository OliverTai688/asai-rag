...
| `05_execution-plans` | 計畫、路線圖與批次任務 | 24 |
| `06_audits-and-reports` | 審計、開發與交付報告 | 11 |
| `07_research-and-design` | 研究與設計探索 | 26 |
| `08_acceptance-and-qa` | 驗收與 QA 文件 | 16 |
...
| `ARC` | Architecture / Design System 架構與設計規則 | `02_architecture-and-rules` | 10 |
| `REF` | Reference 功能參考 | `03_feature-reference` | 0 |
| `PLN` | Plan / Roadmap / Batch 計畫與批次任務 | `05_execution-plans` | 24 |
| `AUD` | Audit 審計文件 | `06_audits-and-reports` | 5 |
| `RPT` | Report 開發/交付/分析報告 | `06_audits-and-reports` | 6 |
| `RES` | Research 研究與設計探索 | `07_research-and-design` | 25 |
| `ACC` | Acceptance / QA 驗收文件 | `08_acceptance-and-qa` | 16 |
